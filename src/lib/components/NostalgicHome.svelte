<script lang="ts">
	...
	let workLoaded = $state<Record<string, boolean>>({});
	let recordLoaded = $state<Record<string, boolean>>({});
</script>
...
<style>
	...
	.nostalgic-home{width:min(900px,100%);margin:0 auto;padding:0 0 1rem;color:#172034;font-family:Verdana,'Yu Gothic',sans-serif}.welcome{padding:.6rem 0 .9rem;text-align:center}.welcome span{display:block;color:#596483;font:700 .62rem monospace;letter-spacing:.24em}.welcome img{display:block;width:min(330px,70%);margin:.25rem auto;mix-blend-mode:multiply}.box{margin-top:.85rem;padding:1rem;border:1px solid #4e5a80;background:rgba(255,255,255,.92);box-shadow:5px 5px 0 rgba(90,101,177,.2)}h1,h2{margin:0 0 .8rem;padding-bottom:.4rem;border-bottom:2px dotted #7d87a2;color:#303b78;font:800 .92rem monospace;letter-spacing:.08em}.work-grid{display:grid;grid-template-columns:1.3fr 1fr 1fr;grid-auto-rows:140px;gap:.5rem}.work-grid>.tile{position:relative;overflow:hidden;border:1px solid #69728b;color:#fff;background:#252b3c}.work-grid>.tile.large{grid-row:span 2}.work-grid>.tile:nth-child(4n){grid-column:2/4}.work-grid img{width:100%;height:100%;object-fit:cover;opacity:0;transform:scale(1.04);transition:opacity .45s ease,transform .45s ease}.work-grid img.loaded{opacity:1;transform:scale(1)}.work-grid .tile>span{position:absolute;right:0;bottom:0;left:0;padding:.3rem .45rem;background:rgba(15,23,42,.8)}.work-grid strong,.work-grid time{display:block;overflow:hidden;font-size:.58rem;text-overflow:ellipsis;white-space:nowrap}.work-grid time{color:#dce2f2;font:.48rem monospace}.more{display:block;margin-top:.7rem;color:#3e4d98;font-size:.72rem;text-align:right}ul{margin:0;padding:0;list-style:none}li{border-bottom:1px dotted #adb4c5}.record-entry{display:grid;grid-template-columns:8.5rem minmax(0,1fr);gap:.8rem;align-items:center;padding:.55rem .2rem;color:#303b78;text-decoration:none}.record-entry>img{width:100%;aspect-ratio:16/9;border:1px solid #69728b;object-fit:cover;opacity:0;transform:scale(1.04);transition:opacity .45s ease,transform .45s ease}.record-entry>img.loaded{opacity:1;transform:scale(1)}.record-copy{display:grid;min-width:0;gap:.28rem}.record-meta{display:flex;align-items:center;gap:.5rem}.record-meta time{color:#68728d;font:.65rem monospace}.record-meta em{padding:.13rem .3rem;color:#fff;background:#8060ad;font-size:.57rem;font-style:normal;text-align:center}.record-meta b{margin-left:auto;color:#d53255;font:700 .58rem monospace}.record-copy>strong{overflow:hidden;font-size:.76rem;text-decoration:underline;text-overflow:ellipsis;white-space:nowrap}.record-copy>small{display:-webkit-box;overflow:hidden;color:#596483;font-size:.62rem;line-height:1.5;-webkit-box-orient:vertical;-webkit-line-clamp:2;line-clamp:2}
