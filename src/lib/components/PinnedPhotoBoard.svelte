...
<style>
	...
	.photo-board{display:contents}.photo-board figure{position:relative;width:92%;margin:0 auto;padding:.3rem .3rem .65rem;background:#fffdf6;box-shadow:2px 5px 9px #28304a3d;transform:rotate(var(--start));transform-origin:50% 2px;will-change:transform}.photo-board figure:nth-child(odd){width:98%}.photo-board figure:nth-child(-n+5){grid-column:1}.photo-board figure:nth-child(n+6){grid-column:3}.photo-board figure:nth-child(1),.photo-board figure:nth-child(6){grid-row:1}.photo-board figure:nth-child(2),.photo-board figure:nth-child(7){grid-row:2}.photo-board figure:nth-child(3),.photo-board figure:nth-child(8){grid-row:3}.photo-board figure:nth-child(4),.photo-board figure:nth-child(9){grid-row:4}.photo-board figure:nth-child(5),.photo-board figure:nth-child(10){grid-row:5}.photo-board img{display:block;width:100%;height:clamp(74px,9vw,105px);object-fit:cover;background:#d8d8d8}.photo-board figure:nth-child(3n+2) img{height:clamp(92px,11vw,126px)}.photo-board figcaption{overflow:hidden;margin-top:.25rem;color:#4e453d;font:italic clamp(.45rem,.65vw,.56rem) 'Comic Sans MS',cursive;text-align:center;text-overflow:ellipsis;white-space:nowrap}.pin{position:absolute;z-index:2;top:-5px;left:50%;width:13px;height:13px;border:2px solid #762f39;border-radius:50%;background:#d64d61;box-shadow:0 2px 2px #26191a66,inset -2px -2px #8c2638;transform:translateX(-50%)}
