...
<style>
	...
	@media(max-width:620px){.photo-board{display:grid;grid-template-columns:1fr 1fr;align-items:start;gap:1.2rem .8rem;margin-top:1.25rem;padding:.9rem .35rem}.photo-board figure,.photo-board figure:nth-child(n){grid-column:auto;grid-row:auto;width:92%;margin:0}.photo-board figure:nth-child(even){justify-self:end}.photo-board figcaption{font-size:.55rem}}
