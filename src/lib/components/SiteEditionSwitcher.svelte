...
<style>
	...
	.swatch{display:block;width:42px;aspect-ratio:1;border:1px solid #202432}.swatch.nostalgic{background-color:#fbfaf4;background-image:linear-gradient(#cfd7e5 1px,transparent 1px),linear-gradient(90deg,#cfd7e5 1px,transparent 1px);background-size:8px 8px}.swatch.zine{background:linear-gradient(145deg,#f3e4b6 0 42%,#283260 43% 67%,#d76c8a 68%)}.swatch.desktop{background:#278d89;box-shadow:inset 7px 9px 0 #c0c0c0,inset 9px 11px 0 #000080}.swatch.broadcast{background:#111;box-shadow:inset 0 0 0 6px #f1d233}.swatch.manga{background:radial-gradient(#111 1px,#fff 1px);background-size:5px 5px;box-shadow:inset 0 0 0 3px #000}
